  ...
  render() {
    ...
    <div className="social-container">
      ...
      <ul>
        ...
        <li>
          <a href="https://www.linkedin.com/in/mariokk/" target="_blank">
          <svg className="link-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
        ...
        <li>
          <a href="https://www.facebook.com/koiram" target="_blank">
          <svg className="fb-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
        ...
        <li>
          <a href="https://www.instagram.com/koiram">
          <svg className="ig-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
